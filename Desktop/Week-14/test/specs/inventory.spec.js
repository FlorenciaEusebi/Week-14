...
describe ('Inventory page testing', () => {
  ...
  describe ('Bike light inventory test', () => {
    ...
    // it('Checking remove button is clickable', async () => {
    //   const addBtn = await $('#add-to-cart-sauce-labs-backpack').isClickable();
    //   await addBtn.click();
    // })
  })
  ...
  describe ('Span content', () => {
    ...
    // it('Checking span title', async () => {
    //   const spanTitle = await $('#header_container > div.header_secondary_container > span');
    //   await expect(spanTitle).toHaveTextContaining('Products')
    // })
